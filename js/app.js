(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper__popular")) new swiper_core_Swiper(".swiper__popular", {
        ...
        if (document.querySelector(".swiper__tranding")) new swiper_core_Swiper(".swiper__tranding", {
            modules: [ Navigation, Pagination, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
